...
// Missing interface from documentation (tools.md)
interface StringResultData {
    value: string;
}
...
/**
 * Interface for UI element match results
 */
interface UIElementMatchResultData {
    results: SimplifiedUINode[];
    count: number;
    query: any;
}
 ...
 */
function validateUINodeStructure(node: SimplifiedUINode): boolean {
 ...
 */
function printUIHierarchy(node: SimplifiedUINode, indent: string = ""): void {
    if (!node) return;
...
async function runTests(params: { testType?: string } = {}): Promise<void> {
    ...
    try {
        ...
        if (testType === "all" || testType === "files") {
            ...
            if (results["write_file"]?.success && results["make_directory"]?.success) {
...
async function testQueryProblemLibrary(results: TestResults): Promise<void> {
    try {
        ...
        const resultString = queryResult as string;
 ...
 */
async function testUsePackage(results: TestResults): Promise<void> {
    try {
        console.log("\nTesting use_package...");
        ...
        const resultString = packageResult as string;
 ...
 */
async function testCalculator(results: TestResults): Promise<void> {
    try {
        console.log("\nTesting calculate...");
        const expressions = [
            "2 + 2",
        ...
        for (const expression of expressions) {
            ...
            // Validate the result
            const calcData = calcResult as CalculationResultData;
 ...
 */
async function testSleep(results: TestResults): Promise<void> {
    try {
        console.log("\nTesting sleep...");
        ...
        for (const duration of testDurations) {
            ...
            // Validate the result
            const sleepData = sleepResult as SleepResultData;
 ...
 */
async function testListFiles(results: TestResults): Promise<void> {
    try {
        console.log("\nTesting list_files...");
        ...
        // Validate the result
        const dirListing = filesList as DirectoryListingData;
...
async function testWriteFile(results: TestResults): Promise<void> {
    try {
        ...
        // Validate the result
        const writeData = writeResult as FileOperationData;
 ...
 */
async function testReadFile(results: TestResults): Promise<void> {
    try {
        console.log("\nTesting read_file...");

        // Check if write_file was successful
        if (!results["write_file"]?.success) {
        ...
        // Validate the result
        const fileData = readResult as FileContentData;
 ...
 */
async function testFileExists(results: TestResults): Promise<void> {
    try {
        console.log("\nTesting file_exists...");
        ...
        // Validate the result
        const existsData = existsResult as FileExistsData;
        ...
        const nonExistsData = nonExistsResult as FileExistsData;
...
async function testMakeDirectory(results: TestResults): Promise<void> {
    try {
        ...
        // Validate the result
        const mkdirData = mkdirResult as FileOperationData;
        ...
        const verifyData = verifyResult as FileExistsData;
 ...
 */
async function testCopyFile(results: TestResults): Promise<void> {
    try {
        console.log("\nTesting copy_file...");
        ...
        // Validate the result
        const copyData = copyResult as FileOperationData;
 ...
 */
async function testMoveFile(results: TestResults): Promise<void> {
    try {
        console.log("\nTesting move_file...");

        // Check if copy_file was successful
        if (!results["copy_file"]?.success) {
        ...
        // Validate the result
        const moveData = moveResult as FileOperationData;
        ...
        const sourceExists = (sourceCheck as FileExistsData).exists;
        const destExists = (destCheck as FileExistsData).exists;
 ...
 */
async function testFindFiles(results: TestResults): Promise<void> {
    try {
        console.log("\nTesting find_files...");
        ...
        // Validate the result
        const findData = findResult as FindFilesResultData;
 ...
 */
async function testFileInfo(results: TestResults): Promise<void> {
    try {
        console.log("\nTesting file_info...");
 ...
 */
async function testZipFiles(results: TestResults): Promise<void> {
    try {
        console.log("\nTesting zip_files...");
        ...
        // Validate the result
        const zipData = zipResult as FileOperationData;
 ...
 */
async function testUnzipFiles(results: TestResults): Promise<void> {
    try {
        console.log("\nTesting unzip_files...");

        // Check if zip_files was successful
        if (!results["zip_files"]?.success) {
        ...
        // Validate the result
        const unzipData = unzipResult as FileOperationData;
        ...
        if (unzipData.successful) {
            ...
            const listData = listResult as DirectoryListingData;
 ...
 */
async function testOpenFile(results: TestResults): Promise<void> {
    try {
        console.log("\nTesting open_file...");
        ...
        // Validate the result
        const openData = openResult as FileOperationData;
 ...
 */
async function testShareFile(results: TestResults): Promise<void> {
    try {
        console.log("\nTesting share_file...");
        ...
        // Validate the result
        const shareData = shareResult as FileOperationData;
 ...
 */
async function testDeleteFile(results: TestResults): Promise<void> {
    try {
        ...
        for (const path of testPaths) {
            ...
            const deleteData = deleteResult as FileOperationData;
 ...
 */
async function testHttpRequest(results: TestResults): Promise<void> {
    try {
        ...
        const getData = getResult as HttpResponseData;
        ...
        const postData = postResult as HttpResponseData;
 ...
 */
async function testDownloadFile(results: TestResults): Promise<void> {
    try {
 ...
 */
async function testDeviceInfo(results: TestResults): Promise<void> {
    try {
        console.log("\nTesting device_info...");
 ...
 */
async function testGetSystemSetting(results: TestResults): Promise<void> {
    try {
 ...
 */
async function testModifySystemSetting(results: TestResults): Promise<void> {
    try {
        ...
        const originalData = getResult as SystemSettingData;
        ...
        // Validate the result
        const modifyData = modifyResult as SystemSettingData;
        ...
        const verifyData = verifyResult as SystemSettingData;
 ...
 */
async function testListInstalledApps(results: TestResults): Promise<void> {
    try {
        ...
        // Validate the result
        const userAppsData = userAppsResult as AppListData;
        ...
        // Validate the result
        const allAppsData = allAppsResult as AppListData;
 ...
 * This is marked as potentially dangerous and requires user authorization
 */
async function testInstallApp(results: TestResults): Promise<void> {
    try {
        console.log("\nTesting install_app...");
 ...
 * This is marked as potentially dangerous and requires user authorization
 */
async function testUninstallApp(results: TestResults): Promise<void> {
    try {
 ...
 */
async function testStartApp(results: TestResults): Promise<void> {
    try {
        console.log("\nTesting start_app...");
        ...
        // Validate the result
        const startData = startResult as AppOperationData;
 ...
 */
async function testStopApp(results: TestResults): Promise<void> {
    try {
        console.log("\nTesting stop_app...");
        ...
        // Validate the result
        const stopData = stopResult as AppOperationData;
 ...
 */
async function testGetPageInfo(results: TestResults): Promise<void> {
    try {
        ...
        function countNodes(node: SimplifiedUINode): void {
            if (!node) return;
 ...
 */
async function testClickElement(results: TestResults): Promise<void> {
    console.log("\n--- Testing click_element ---");
    try {
        // First get page info to have a reference point
        const pageInfo = await toolCall("get_page_info") as UIPageResultData;
 ...
 * Tests the tap tool
 */
async function testTap(results: TestResults): Promise<void> {
    try {
        console.log("\nTesting tap...");
        ...
        // Validate the result
        const tapData = tapResult as UIActionResultData;
 ...
 */
async function testSetInputText(results: TestResults): Promise<void> {
    try {
        ...
        if (inputField) {
            ...
            // Validate the result
            const inputData = inputResult as UIActionResultData;
 ...
 */
async function testPressKey(results: TestResults): Promise<void> {
    try {
        console.log("\nTesting press_key...");
        ...
        // Validate the result
        const backData = backResult as UIActionResultData;
        ...
        // Validate the result
        const homeData = homeResult as UIActionResultData;
 ...
 */
async function testSwipe(results: TestResults): Promise<void> {
    console.log("\n--- Testing swipe ---");
    try {
        // Get screen info to determine good coordinates
        const deviceResult = await toolCall("device_info");
        ...
        // Validate the result
        const swipeData = swipeResult as UIActionResultData;
        ...
        // Validate the result
        const swipeHData = swipeHResult as UIActionResultData;
...
exports.testCategory = function (params: { testType: string }): Promise<void> {
