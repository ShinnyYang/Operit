...
exports.ensureDeepSeekHarnessWebServer = ensureDeepSeekHarnessWebServer;
...
async function executeRuntimeCommandStreaming(command, timeoutMs, onProgress) {
    const sessionId = await getTerminalSessionId();
...
function buildResult(success, status, message) {
    return {
        success,
        status,
        message,
...
async function ensureDeepSeekHarnessWebServer(params = {}) {
