...
const AIComputerTools = (function () {
    async function computer_get_tabs(params) { return await toolCall('ai_computer', 'computer_get_tabs', params); }
    async function computer_switch_to_tab(params) { return await toolCall('ai_computer', 'computer_switch_to_tab', params); }
    async function computer_open_desktop(params) { return await toolCall('ai_computer', 'computer_open_desktop', params); }
    async function computer_open_browser(params) { return await toolCall('ai_computer', 'computer_open_browser', params); }
    async function computer_get_page_info(params) { return await toolCall('ai_computer', 'computer_get_page_info', params); }
    async function computer_click_element(params) { return await toolCall('ai_computer', 'computer_click_element', params); }
    async function computer_scroll_by(params) { return await toolCall('ai_computer', 'computer_scroll_by', params); }
    async function computer_input_text(params) { return await toolCall('ai_computer', 'computer_input_text', params); }
    async function computer_close_tab(params) { return await toolCall('ai_computer', 'computer_close_tab', params); }
    async function computer_go_back(params) { return await toolCall('ai_computer', 'computer_go_back', params); }
    ...
    return {
        ...
        computer_switch_to_tab: (params) => wrapToolExecution(computer_switch_to_tab, params),
        computer_open_desktop: (params) => wrapToolExecution(computer_open_desktop, params),
        computer_open_browser: (params) => wrapToolExecution(computer_open_browser, params),
        computer_get_page_info: (params) => wrapToolExecution(computer_get_page_info, params),
        computer_click_element: (params) => wrapToolExecution(computer_click_element, params),
        computer_scroll_by: (params) => wrapToolExecution(computer_scroll_by, params),
        computer_input_text: (params) => wrapToolExecution(computer_input_text, params),
        computer_close_tab: (params) => wrapToolExecution(computer_close_tab, params),
